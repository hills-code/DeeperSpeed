...
class TorchBackend(Backend):
    ...
    def init_process_group(self, backend, timeout, init_method, rank, world_size):
        if not torch.distributed.is_initialized():
            utils.logger.info('Begin Initializing TorchBackend in DeepSpeed with backend {}'.format(backend))
            ...
            utils.logger.info('End Initializing TorchBackend in DeepSpeed with backend {}'.format(backend))
